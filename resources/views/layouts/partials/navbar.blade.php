<nav class="navbar navbar-default">
        ...
        <!--Laravel güvenlik olarak POST un çalışablimesi için bu field helperını kullanıyoruz !!-->
                    {{csrf_field()}}
...
<!--Oturum Açmamış kullanıcıların görebileceği kod bloğu-->
                    @guest
                    <li><a href="{{route('kullanici.oturumac')}}">Oturum Aç</a></li>
                    <li><a href="{{route('kullanici.kaydol')}}">Kaydol</a></li>
                    @endguest
<!--Oturum açmış kullanıcıların görebileceği kod bloğu-->
                    @auth
                        <li class="dropdown">
