                ...
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="item {{$index == 0 ? 'active' :''}}">
                            <img src="http://via.placeholder.com/400x400?text=UrunResmi" alt="...">
                ...
                <div class="panel panel-default" id="sidebar-product">
                    ...
                    <div class="panel-body">
                        <a href="{{route('urun',$urun_gunun_firsati->slug)}}">
                            <img src="http://via.placeholder.com/400x400?text=UrunResmi" class="img-responsive">
                    ...
                    <div class="row">
                        @foreach($urunler_one_cikan as $urun)
                            <div class="col-md-3 product">
                                ...
                                <p><a href="{{route('urun',$urun->slug)}}">{{$urun->urun_adi}}
                                    </a></p>
