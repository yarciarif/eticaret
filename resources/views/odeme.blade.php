...
@section("content")
 <div class="container">
        <div class="bg-content">
            <h2>Ödeme</h2>
<!--Gerçek bir bankayla çalışacagımız zaman buraya bankanın ödeme yapma ile ilgili sayfasına yönlendireceğiz onlar da olumlu ya da olumsız olarak bize geri dönüş yapacaklar -->
