...
@section("content")
	<div class="container">
        ...
        <table class="table table-bordererd table-hover">
                <tr>
                    <th colspan="2" style="text-align: center">Ürün</th>
                    <th>Adet Fiyatı</th>
                    <th style="padding-left: 30px">Adet</th>
                    <th>Tutar</th>
                </tr>
...
<!--Sepetten Ürün Kaldırma Formu-->
                    ...
                    <td>
                        ...
                        <span style="padding: 10px 20px;text-align: center" >{{$urunCartItem->qty}}</span>
